...
import EcgInbox from "./pages/EcgInbox/EcgInbox";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          ...
          element={
            <PrivateRoute allowedRoles={["cardiologue", "admin"]}>
              <CardiologueDashboard />
            </PrivateRoute>
          }
        />
        <Route
          path="/cardiologue/patients"
          element={
            <PrivateRoute allowedRoles={["cardiologue", "admin"]}>
              <Patients />
            </PrivateRoute>
        ...
        />
        <Route
          path="/cardiologue/signaux-vitaux"
          element={
            <PrivateRoute allowedRoles={["cardiologue", "admin"]}>
              <SignauxVitaux />
            </PrivateRoute>
        ...
        />
        <Route
          path="/cardiologue/signaux-vitaux/historique"
          element={
            <PrivateRoute allowedRoles={["cardiologue", "admin"]}>
              <HistoriqueECG />
            </PrivateRoute>
        ...
        />
        <Route
          path="/cardiologue/reception-ecg"
          element={
            <PrivateRoute allowedRoles={["cardiologue", "admin"]}>
              <EcgInbox />
            </PrivateRoute>
